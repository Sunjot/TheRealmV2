  ...
  render() {
    return (
      <div className="content">
        ...
        GRRM is also a co-executive producer for the show, and so the creators Benioff and
        Weiss know how the show will end its final few seasons (which are largely based on the last
        2 novels).</p>
      </div>
    );
  }
