      ...
      <div className="content">
        ...
        <section className="timeline">
          <ul>
            <li>
              <div>
                <p className="miniheading">Targaryen Dynasty</p>
                <p>For quite some time before the beginning of the series, the Targaryens ruled the Seven
                Kingdoms. They were a long-time dynasty and the crown had been passed down their family
                line for 300 years. The last king before the war goes down is Aerys Targaryen.  </p>
              </div>
            </li>
            <li>
              <div>
                <p className="miniheading">The Absolute Madman</p>
                <p>In case you missed it, Targaryens marry brother to sister to keep
                ...
                (Rebelled. Robert's Rebellion. See where I'm going?)</p>
              </div>
            </li>
            <li>
              <div>
                <p className="miniheading">Broken Marriage</p>
                <p>Rhaegar was married to Elia Martell but he had feelings for someone else - Robert's wife,
                ...
                they wanted answers.</p>
              </div>
            </li>
            <li>
              <div>
                <p className="miniheading">Trial by Fire?</p>
                <p>Brandon Stark (Lyanna's brother) showed up at King's Landing demanding that Rhaegar be
                ...
                madman? Well, he had Rickon burned alive when he showed up and Brandon was strangled.</p>
              </div>
            </li>
            <li>
              <div>
                <p className="miniheading">Battle of the Trident</p>
                <p>Thus formed the alliance between House Stark, Baratheon, Arryn, and Tully. Lyanna's brother,
                ...
                during the war with Eddard by her side after he rescued her.</p>
              </div>
            </li>
            <li>
              <div>
                <p className="miniheading">Sack of King's Landing</p>
                <p>With King's Landing now unprotected, it was a matter of time before the Rebels would
                ...
                Aerys during this sack. Elia and her two children were murdered by Gregor Clegane.</p>
              </div>
            </li>
            <li>
              <div>
                <p className="miniheading">Flee the Scene</p>
                <p>Before Aerys was killed, he had his pregnant wife Rhaella flee to
                ...
                Daenerys taken into exile in the Free Cities.</p>
              </div>
            </li>
            <li>
              <div>
                <p className="miniheading">The Aftermath</p>
                <p>Back at King's Landing, Eddard was not happy with the way House Lannister handled things and
                wanted them punished, but Robert was more forgiving with the Targaryen dynasty finally over.
                He claimed the Iron Throne, married Cersei Lannister and made Jon Arryn his Hand. </p>
              </div>
            </li>
            <li>
              <div>
                <p className="miniheading">15 years later...</p>
                <p>Ah yes, we've finally reached the beginning of the series. Daenerys is a lot older but
                ...
                And so we begin - strap on tight.</p>
              </div>
            </li>
          </ul>
        </section>
